...
"""
pont_latex=r"""
\text{PI(ant)} = \frac{\text{SIOK}}{\text{85}} \times 100
"""
pont_latex_post=r"""
...
mode = st.selectbox(
    'Sollen frühere Analysen geladen werden oder wird ein Neupatient angelegt?',
    ('neue Analyse', 'lade existierende Analyse'))
...
siok = upper_anterior_sum
siuk = lower_anterior_sum
...
#--Auswertung Transversale Abweichungen ---------
st.write(" ")
st.subheader('Transversale Abweichungen ')
st.markdown('''**Transversale Breite (Index nach Schmuth und Pont Index)**''')
st.write("")
...
col1.write("")
col1.write("")
col1.write("**Pont Index:**")
col1.latex(pont_latex)
col2.write("")
col2.metric(label="", value=round(siok*100/85,1), delta=None)
...
col4.write("")
col4.write("")
col4.write("**Pont Index:**")
col4.latex(pont_latex_post)
col5.write("")
...
st.write(" ")
st.subheader('Lundström Analyse ')
st.markdown('''**Platzangebot vs. Platzbedarf nach Gruppen**''')
st.write("")
col1, col2 = st.columns(2)
...
if st.button("save to file"):
    ...
    'ttsr': [ttsr],
    'atsr': [atsr],
    'messung_ant_ok': [gemessen_ant_ok],
    'messung_ant_uk': [gemessen_ant_uk],
